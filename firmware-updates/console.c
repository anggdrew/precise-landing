...
void console_rx_restart(void) //comment out this function if UART is needed!!!!!!!
{
    //stub func due to undefined reference to a console_rx_restart func in uart_console.c
}