...
#define DIAGMSG(...) printf(__VA_ARGS__)
#ifndef DIAGMSG
#define DIAGMSG(s,u)
#endif
...
inline static bool
uwb_dw1000_txrf_power_value(struct uwb_dev * dev, uint8_t *reg, dpl_float32_t coarse, dpl_float32_t fine)
{
...
inline static struct uwb_dev_status
uwb_dw1000_set_rx_window(struct uwb_dev *dev, uint64_t rx_start, uint64_t rx_end)
{
    return dw1000_set_rx_window((dw1000_dev_instance_t *)dev, rx_start, rx_end);
}

inline static struct uwb_dev_status
uwb_dw1000_set_abs_timeout(struct uwb_dev *dev, uint64_t rx_end)
{
...
inline static int
uwb_dw1000_tx_wait(struct uwb_dev* dev, dpl_time_t timeout)
{
...
inline static void
uwb_dw1000_phy_repeated_frames(struct uwb_dev* dev, uint64_t rate)
{
...
inline static dpl_float32_t
uwb_dw1000_calc_seq_rssi(struct uwb_dev * dev, struct uwb_dev_rxdiag * diag,
...
inline static dpl_float32_t
uwb_dw1000_estimate_los(struct uwb_dev * dev, dpl_float32_t rssi, dpl_float32_t fppl)
{
    return dw1000_estimate_los(rssi, fppl);
}

static dpl_float32_t uwb_dw1000_calc_pdoa(struct uwb_dev * dev, struct uwb_dev_rxdiag * diag)
{
...
static const struct uwb_driver_funcs dw1000_uwb_funcs = {
    ...
    .uf_txrf_power_value = uwb_dw1000_txrf_power_value,
    ...
    .uf_set_rx_window = uwb_dw1000_set_rx_window,
    .uf_set_abs_timeout = uwb_dw1000_set_abs_timeout,
    ...
    .uf_read_sts_rxtime = uwb_dw1000_read_sts_rxtime,
    ...
    .uf_phy_data_duration = uwb_dw1000_phy_data_duration,
    .uf_phy_forcetrxoff = uwb_dw1000_phy_forcetrxoff,
    .uf_phy_rx_reset = uwb_dw1000_phy_rx_reset,
    .uf_phy_repeated_frames = uwb_dw1000_phy_repeated_frames,
    ...
    .uf_calc_seq_rssi = uwb_dw1000_calc_seq_rssi,
    .uf_calc_fppl = uwb_dw1000_calc_fppl,
    .uf_estimate_los = uwb_dw1000_estimate_los,
    .uf_calc_pdoa = uwb_dw1000_calc_pdoa,
    .uf_mac_framefilter = uwb_dw1000_mac_framefilter,
    .uf_set_autoack = uwb_dw1000_set_autoack,
    .uf_set_autoack_delay = uwb_dw1000_set_autoack_delay,
    .uf_event_cnt_ctrl = uwb_dw1000_event_cnt_ctrl,
    .uf_event_cnt_read = uwb_dw1000_event_cnt_read
};
...
dw1000_dev_init(struct os_dev *odev, void *arg)
{
    ...
    DIAGMSG("{\"utime\": %lu,\"msg\": \"dw1000_dev_init\"}\n", (unsigned long)dpl_cputime_ticks_to_usecs(dpl_cputime_get32()));
#endif
